...
<section className="flex flex-col text-center py-32">
  ...
  <Button className="text-white ml-[550px] px-16 bg-[#23A6F0] w-[106px] h-[22px] py-5 rounded-sm">Try it free now</Button>
<div className="flex md:ml-[520px] mt-10 space-x-5">
<a
  href="tel:+923132480307"
  aria-label="Twitter"
>
  <FaTwitter size={37} className=" text-blue-700" />
